...
class SignUpActivity : AppCompatActivity() {
    ...
    private fun saveUserInfo(fullName: String, userName: String, email: String, password: String, progressDialog: ProgressDialog) {
        ...
        userMap["email"] = email
        userMap["bio"] = "Tes1"
        userMap["image"] = "https://firebasestorage.googleapis.com/v0/b/instagramandrofix-ca2b5.appspot.com/o/images%2Fprofile.png?alt=media&token=d66f5962-8668-4f73-bdd2-85ccf004f3f7"
